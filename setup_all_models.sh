...
echo "=========================================="
echo "LIVA Jetson AI - Complete Model Setup"
echo "=========================================="
echo ""
echo "This script will download:"
echo "  • Whisper base model (~147 MB)"
echo "  • Deepseek R1 Distill model (~1.2 GB) - thinking"
echo "  • Qwen 2.5 Instruct model (~1.0 GB) - non-thinking"
echo ""
echo "Total: ~2.3 GB"
echo "Time: 10-20 minutes (depending on internet speed)"
echo ""
